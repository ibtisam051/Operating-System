...
{
    int *ptr = (int *)malloc((size / noOfProcesses) * sizeof(int));
    ...
    else
    {
        ...
        {                                           // for array update counter
            ...
            for (int i = 0; i < noOfProcesses; i++) // 4 no. of processes
            {
                ...
                int *arr = (int *)malloc((size / noOfProcesses) * sizeof(int));
                arr = DivideArray(ptr);
        ...
        else
        {
            ...
            for (int i = 0; i < noOfProcesses; i++) // 4 no. of processes
            {
                ...
                else if (i == noOfProcesses - 1)
                {
                    ...
                    int *newarr = (int *)malloc((size / noOfProcesses) * sizeof(int));
                    newarr = DivideArray2(ptr, newSize);
